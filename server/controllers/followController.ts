...
export const follow = async (req: IRequest, res: Response) => {
  try {
    ...
    return handleControllerError(error, res, "failedToCreateFollow");
  }
};
...
export const deleteFollow = async (req: IRequest, res: Response) => {
  try {
    ...
    return handleControllerError(error, res, "failedToDeleteFollow");
  }
};
...
export const isFollowing = async (req: IRequest, res: Response) => {
  try {
    ...
    return handleControllerError(error, res, "failedToCheckFollowing");
  }
};
...
export const getFollowing = async (req: IRequest, res: Response) => {
  try {
    ...
    return handleControllerError(error, res, "failedToGetFollowing");
  }
};
